...
user_invocable: true
description: |
  产品设计心理学分析。用认知/行为/情绪三维分析指导设计，引用 Nielsen 原则和格式塔心理学。
  Use when: 讨论用户行为或功能设计、分析体验问题、规划新功能、撰写 PRD 或交互设计。
---
...
- 目标明确："将首页加载时间从 3.2s 降至 1.5s 以内"
- 用户场景具体："运营人员每天 9:00 批量导入 500 条商品数据"
- 验收标准可量化："导入完成后 30s 内搜索可命中新商品"
- 边界清晰："仅支持 CSV 格式，单次最大 1000 条"

### 坏的需求分析

- 目标模糊："提升用户体验"（无法量化，无法验收）
- 场景泛化："用户使用搜索功能"（哪个用户？什么场景？多大量级？）
- 验收标准主观："界面美观、操作流畅"（不同人标准不同）
- 边界缺失："支持数据导入"（什么格式？多大？错误怎么处理？）
